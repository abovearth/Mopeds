...
public class TinyCopperMopedRenderer extends GeoEntityRenderer<TinyCopperMopedEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TinyCopperMopedEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
