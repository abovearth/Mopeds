...
public class CopperMopedRenderer extends GeoEntityRenderer<CopperMopedEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, CopperMopedEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
